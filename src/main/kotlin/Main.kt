...
arrayNumber()
    person()
   println( names("Cate Cate", "Nelson Mandela", "Trevor Noah"))
    var cars = listOf(
...
fun person(){
    ...
    var person2 =personObjects("Mirriam Rapaine", 44, 1.9,57 )
    var person3 =personObjects("Linet Warukira", 29, 1.8,27 )
...
fun names(name:String, name1:String, name2: String):String{
    var x = (arrayOf(name,name1, name2,))
